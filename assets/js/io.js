...
(function (global) {
  ...
  /* ---------- Загвар файл — түгээмэл хэдхэн асуулт ---------- */
  function template() {
    const sample = [{
      'Хороо': 5, 'Гудамж, хэсэг': 'Сурагчийн гудамж', 'Байр, хашаа': '12-р хашаа',
      'Өрхийн тэргүүн': 'Б.Батбаяр', 'Утас': '99112233', 'Ам бүл': 4,
      'Дэмжлэг': 'Дэмжигч', 'Нам': 'МАН', 'Тэмдэглэл': 'Дулааны асуудалтай'
    }, {
      'Хороо': 5, 'Гудамж, хэсэг': 'Сурагчийн гудамж', 'Байр, хашаа': '14-р хашаа',
      'Өрхийн тэргүүн': 'Д.Оюунчимэг', 'Утас': '95556677', 'Ам бүл': 3,
      'Дэмжлэг': 'Эргэлзэгч', 'Нам': '', 'Тэмдэглэл': ''
    }, {
      'Хороо': 12, 'Гудамж, хэсэг': 'Их тойруу', 'Байр, хашаа': '45-р байр, 8 тоот',
      'Өрхийн тэргүүн': 'С.Ганбаатар', 'Утас': '', 'Ам бүл': 5,
      'Дэмжлэг': '', 'Нам': '', 'Тэмдэглэл': 'Гэрт байгаагүй'
    }];
    const wb = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(wb, XLSX.utils.json_to_sheet(sample), 'Загвар');
    const guide = [
      { 'Асуулт': 'Хороо', 'Тайлбар': 'Заавал. 1–24 тоо (эсвэл «5-р хороо» гэж бичсэн ч болно).' },
      { 'Асуулт': 'Гудамж, хэсэг', 'Тайлбар': 'Байршлыг үүгээр тодорхойлно — координат огт хэрэггүй. Нэг гудамжны өрхүүд зураг дээр зэрэгцэж гарна.' },
      { 'Асуулт': 'Байр, хашаа', 'Тайлбар': 'Чөлөөт бичвэр: «12-р хашаа», «45-р байр, 8 тоот» г.м.' },
      { 'Асуулт': 'Өрхийн тэргүүн', 'Тайлбар': 'Овгийн эхний үсэг + нэр.' },
      { 'Асуулт': 'Утас', 'Тайлбар': 'Мэдэхгүй бол хоосон үлдээнэ.' },
      { 'Асуулт': 'Ам бүл', 'Тайлбар': 'Өрхийн нийт хүний тоо.' },
      { 'Асуулт': 'Дэмжлэг', 'Тайлбар': 'Үгээр: Бат дэмжигч / Дэмжигч / Эргэлзэгч / Эсрэг. Эсвэл 0–5 тоо. Мэдэхгүй бол хоосон.' },
      { 'Асуулт': 'Нам', 'Тайлбар': 'Мэдэхгүй бол хоосон.' },
      { 'Асуулт': 'Тэмдэглэл', 'Тайлбар': 'Чөлөөт бичвэр.' },
      { 'Асуулт': '', 'Тайлбар': '' },
      { 'Асуулт': 'Санамж', 'Тайлбар': 'Аль ч нүд хоосон байж болно (Хорооноос бусад). Багана нэмбэл импортын үед тааруулж өгнө. Дүүрэг бичих хэрэггүй — бүгд Чингэлтэй.' }
    ];
